1.Given an array of positive integers of size 'n'.Find the second largest distinct element in the array. If the second largest number doesnt exist return -1
